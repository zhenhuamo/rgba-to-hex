...
export default function OklchToCmykConverter() {
  const [oklch, setOklch] = useState({ l: 0.628, c: 0.258, h: 29 });
  const [cmyk, setCmyk] = useState({ c: 0, m: 75, y: 100, k: 0 });
  const [conversionDirection, setConversionDirection] = useState<'oklch-to-cmyk' | 'cmyk-to-oklch'>('oklch-to-cmyk');
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-6">
            <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-pink-500 mb-2">
              OKLCH ↔ CMYK Color Converter
            </h1>
            <p className="text-gray-600 dark:text-gray-300 text-sm">
              Convert between OKLCH and CMYK color spaces for print design workflows
            </p>
          </div>
