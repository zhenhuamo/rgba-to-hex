  ...
  const toolCategories = [
    {
      ...
      tools: [
        ...
        { name: 'RGB to Hexadecimal', href: '/tools/rgb-to-hexadecimal', color: 'from-emerald-500 to-teal-500' },
        ...
        { name: 'RGB to OKLAB', href: '/tools/rgb-to-oklab', color: 'from-rose-600 to-purple-600' },
        { name: 'RGB to XYZ', href: '/tools/rgb-to-xyz', color: 'from-sky-500 to-sky-600' },
        { name: 'RGB to UV', href: '/tools/rgb-to-uv', color: 'from-cyan-600 to-blue-600' },
