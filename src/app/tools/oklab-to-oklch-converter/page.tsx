...
export default function OklabToOklchConverter() {
  const [oklch, setOklch] = useState({ l: 0.628, c: 0.258, h: 29.23 });
  const [oklab, setOklab] = useState({ l: 0.628, a: 0.226, b: 0.125 });
  const [conversionDirection, setConversionDirection] = useState<'oklab-to-oklch' | 'oklch-to-oklab'>('oklab-to-oklch');
            ...
            <div className="mt-12 bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
              ...
              <div className="bg-gray-900 rounded-lg p-6 overflow-x-auto">
                <pre className="text-sm text-gray-100">
                  <code>{`// OKLAB to OKLCH conversion function
          ...
          {!isEmbedded && (
            <div className="mt-12">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <a href="/tools/oklch-to-oklab-converter" className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                  <h3 className="font-semibold text-lg mb-2">OKLCH to OKLAB</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">Convert OKLCH colors to OKLAB format</p>
                </a>
